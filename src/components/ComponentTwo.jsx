...
import image from "../assets/imgThree.png";
...
function ComponentTwo() {
  return (
    <Wrapper>
      <Box>
        <LeftBox>
          <TitleText>GET INSPIRed By PEERS AND EXPERTS </TitleText>
          <DescriptionText>
            Becoming a successful entrepreneur means surrounding yourself with
            an inspiring ecosystem like DEN.
          </DescriptionText>
          <UlText>
            <LiText>Get constructive feedback from industry experts</LiText>
            <LiText>Read startup stories, successes, and failures</LiText>
            <LiText>
              Get help on investor relations topics like term sheets
            </LiText>
            <LiText>Find best practices and professional templates</LiText>
          </UlText>
        </LeftBox>
        <RightBox>
          <img src={image} alt={""} />
